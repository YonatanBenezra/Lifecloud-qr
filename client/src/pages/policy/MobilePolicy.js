    ...
    return (
       ...
       <Topbar />
        ...
        <div className="policy-container">
            ...
            <h1 className='MobilePolicy-title'>LifeCloud מדיניות פרטיות</h1>
            ...
            {data.map((item,i) =>(
                ...
                <div className="MobileItem">
                    ...
                    <div className="mobileTitle" onClick={()=> info(i)}>
                        
                        <h2 className="fntFmly">{item.question}</h2>
                        <span className="span2 fntFmly">{selected === i ? '-' : '+'}</span>
                    </div>
