...
const HomeMobile = (props) => {
  ...
  return (
    <div className="home-mobile-whole-page">
      ...
      >
      <div style={{width:"100%",height:"90px",position:"absolute",bottom:"0px"}}>
      ...
      <div className="" style={{textAlign:"center"}}>
        ...
        {user ? (
          ...
          >
            <div className="mobile-home-profile-creation-btn">ליצירת פרופיל ללא עלות</div>
          </Link>
        ) : (
          <Link
            to='/register'
        ...
        <div className="text-section-container">
          ...
          <div className="bottom-image-container">
            ...
            <img
              alt=""
              src={rightCloud}
              style={{ position: 'relative', right: 0, height: '150px',width:"150px",top:"-48px"}}
            ></img>
          </div>
        </div>
      </div>
      ...
      <div className="">
        <div className=''>
          ...
          <h1 className="gridTxtH">קיבור עמודי המנוח ברשתות החברתיות הקיימות. </h1>
          <p className="gridPlus">+</p>
                  <h1 className="grtidTxtP">קרא עוד</h1></div>
          </div>
          <div className="bx">
          <img src={f14} width="100%" height="150px"/>
          <div className="gridTxt">
          <h1 className="gridTxtH">  קישור לרשתות חברתיות
            </h1>
            <p className="gridPlus">+</p>
          <h1 className="grtidTxtP" >
            קרא עמודי </h1></div>
          </div> 
          </div>
          <div className="gridBar">
          ...
          <div className="gridTxt"><h1 className="gridTxtH" >
             ייחודי QR קוד
            </h1>
            <p className="gridPlus">+</p>
            <h1 className="grtidTxtP" >
      ...
      {/*<div>
        ...
        <Slider {...settings} style={{width:"90%",height:"280px"}}>
          <a href="#">
            ...
            >
              <img src={exampleProfileImage} className="mobile-example-profile-image" />
            </div>
          </a>
          <a href="#">
           <div 
