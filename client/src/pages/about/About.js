          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                ...
                <div>
                  <p>
                    Life Cloud הינה פלטפורמה וידידותית למשתמש, נוחה להפעלה
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                ...
                <p>
                  איבדתי את היקרה לי מכל! ואז בכל פעם שחיפשתי באלבומים ישנים או
                  ניסיתי לאתר סרטון או תמונה, Life Cloud זה היה כמעט בלתי אפשרי.
                  מכאן נולד. כי בעולם הכל כך מתקדם של היום, שבו אתה יכול להגיע
                  לאנשים בקצה השני של העולם בנגיעה על מסך, חייבת הייתה להיות דרך
