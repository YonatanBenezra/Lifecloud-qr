...
import { Gallery } from '../../components/gallery/MobileGallery';
// import { AuthContext } from '../../context/AuthContext';
import { useParams, useLocation } from 'react-router';
import Memory from '../../components/memory/MobileMemory';
...
import GraveMap from './MobileGraveMap';
    ...
    return (
      <div className="profile-details">
        ...
        <div className="profile-details-first">
          ...
          ></img>
          <div className="Mobiledeceased-details">
            <h1 className="MobileProfileH1">{`${profiledata?.degree} ${profiledata?.firstName} ${profiledata?.lastName}`}</h1>
            <p className="MobileProfileP">
              {moment(profiledata?.birthDate).utc().format('YYYY-DD-MM')} -{' '}
              {moment(profiledata?.deathDate).utc().format('YYYY-DD-MM')}
            </p>
            <p className="MobileProfileP">{profiledata?.city}</p>
          </div>
        ...
        >
          <div className="memorial-container">
            <div className="profile-details-title">
              <h1 className="profileTitle">תאריך האזכרה</h1>
            </div>
            ...
            <div className="details-and-icons">
              ...
              <div className="memorial-details">
                ...
                <h3>
                  ...
                  <span className="ff dbT">{profiledata?.birthDate?.split('T')[0]}</span>
                </h3>
                <h3>
                  <span className="separator">| </span>
                  <span className="dash">- </span>
                  <span className="ff dbT">{profiledata?.hebDeathDate}</span>
                </h3>
                <h3>
                  <span className="separator">| </span>
                  <span className="dash">- </span>
                  <span className="ff dbT">{profiledata.wazeLocation}</span>
                </h3>
              </div>
              ...
              <div className="zmm">
                <img
                  src={zoom}
                  alt=""
                  className={`${!profiledata.zoomLink && 'disabled'} zmmIcon`}
                />
                <p className="ff dbT zmmTxt">ןכדע+</p>
                </div>
                <a
                  href={`https://www.waze.com/ul?q=${profiledata.wazeLocation}`}
                >
                <div className="zmm">
                  <img src={waze} alt="" className="zmmIcon"></img>
                  <p className="ff dbT zmmTxt">םוקימ ףסוה+</p>
                  </div>
                </a>
              </div>
            </div>
          ...
          <div className="gallery-container">
            ...
            <div onClick={() => setShow('gallery')} className="full-btn ff">
              {' '}
              לכל הגלריה +
            </div>
          </div>
          <div className="grave-location-container">
            <h1 className="grave-location-title ff">מיקום ותמונת הקבר</h1>
            <div className="Mobilegrave-imgs-container">
          ...
          <div className="memories-div">
            <h1 className="memories-title ff">זכרונות</h1>
            <div className="Mobilememories-container">
              {memoryData.length > 0 ? (
                memoryData.map(
                  (
                    imgData,
                    ...
                    <Popup
                      trigger={
                        <div style={{width:"50%",display:"inline-block",padding:"10px 0px"}}>
                        <div className="" style={{height:"230px"}} key={index}>
                          <img
                            src={`${process.env.REACT_APP_API_URL}/${imgData.file}`}
                            alt=""
                            className=""
                            style={{width:"100%",padding:"10px",height:"200px",marginBottom:"10px",borderRadius:"20px"}}
                          ></img>
                          ...
                          <p className="picName">ןגמ ןדע  </p>
                          <p className="picName"> תובוגת (3) | 20.12.21</p>
                          </div>
                          </div>
                        </div>
                      }
            ...
            <div className="MobileMemoryActions" style={{marginTop:"50px"}}>
              <div
                className={
