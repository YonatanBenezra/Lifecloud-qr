    ...
    <div className="profile-creation-container">
      ...
      <div className="profile-creation">
        <div className="">
          ...
          <div className="MobilepProfileImages">
            ...
            <div className="MobileProfileImageContainer">
              <img
                className="mobileImg"
                src={
                  imgData
              ...
              ></img>
              <div>
              <label for="prfPic" className="prfPicTxt">וסף תמונת פרופיל +</label>
              <input 
                type="file"
                id="prfPic"
                name="profileImg"
            ...
            <div className="MobileProfileImageContainer">
              <img
                ...
                alt=""
              ></img>
              <label for="cvrPic" className="cvrPicTxt">וסף תמונה של הקבר +</label>
              <input
                className=""
                id="cvrPic"
                type="file"
        ...
        {/*RegistratioN Form*/}
         ...
         <div className="loginRight">
            <div className="RegBox">
              <form className="MobileProfileCreationBox" onSubmit={handleClick}>
                <div
                ...
                <div className="birth-date-container" style={{textAlign:"center"}}>
                  <h1>תאריך לידה</h1>
                  <h1>תאריך פטירה</h1>
                </div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <div style={{padding:"10px"}}>
                        <img
                          className="MobileCreationGalleryImg"
                          src={
                            profiledata.gallery &&
                ...
                <div style={{padding:"5px"}}>
                  ...
                  <h1 className="txtMap">מיקום הקבר</h1>
                   <div className="mpBox">
                      <input
                ...
                <button className="lstBtn" type="submit">
                  שמור
                </button>
                </div>
