      ...
      <div className="profile-creation">
        <div className="">
          <div className="loginLeft" style={{ marginBottom: '3rem' }}>
            <h3 className="ff ttlTxt ttlClr">צור פרופיל ראשי</h3>
          </div>
          ...
          <div className="loginRight">
            <div className="RegBox">
              <form className="MobileProfileCreationBox" onSubmit={handleClick}>
                ...
                >
                  <h1 className="htxt">העלאת מדיה</h1>
                  <div>
                    <div
                ...
                <div style={{ textAlign: 'center' }}>
                  <h1 className="htxt">על העמותה</h1>
                  <textarea
                    ref={description}
                ...
                <div className="radio-container-register">
                  <h3 style={{ color: '#6097BF' }} className="htxt">פרטיות</h3>
                  <div
                    style={{
                      width: 'unset',
                      paddingRight: '10px',
