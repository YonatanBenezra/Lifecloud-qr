                    ...
                    <div className={selected === i ? 'content show': 'content'}>
                        {item.sections && item.sections.map((section, i)=> (
                            <div className='answer-section' key={'section-'+i}>
                                <div className='section-title'>{section.subTitle && section.subTitle}</div>
                                <div>
                                    {section.paragraphs && section.paragraphs.map((p, i)=> (
                                        <div className={'answer-paragraph ' + (section.subTitle ? 'small-text ' : '') + (p.noMargin ? 'no-margin' : '') + (p.bold ? ' bold' : '')} key={'paragraph-'+i}>
                                            {p.p}
                                        </div>
                                    ))} 
                                </div>
 ...
 const data = [
...

    {
        ...
        sections: [
            ...
            {   
                subTitle: '3.2 מבלי לגרוע מהאמור לעיל, אנו נהיה רשאים לעשות שימוש במידע לא אישי למטרות לגיטימיות שונות, למשל: לצורך שיפור שירותים ויישומים; התאמה של תכנים, שירותים ופרסומות; מחקר סטטיסטי, וכיו"ב.',
            }
    ...
    },
    {
        ...
        sections: [
            {
                subTitle: '4.1 אנו לא נעביר לצדדים שלישיים את המידע האישי שנאסף אודותיך, בלא הסכמתך, אלא במקרים המפורטים להלן:',
                paragraphs: [
                    {
            ...
            {
                subTitle: '4.2 הנך מסכים לכך שהחברה תהיה רשאית להעביר, על פי שיקול דעתה, את המידע האישי אל מחוץ לגבולות ישראל, הגם שדין המדינה אליה מועבר ו/או בה מאוחסן המידע האישי מבטיח רמת הגנה שונה מרמת ההגנה על מידע הקבועה בדין הישראלי.'
            }
        ]
    },
    {
