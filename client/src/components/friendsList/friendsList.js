                        ...
                        return (
                            <div className="friend-request" key={friend.user && friend.user[0]._id}>
                                ...
                                <div>
                                    ...
                                    |
                                    <span style={{ cursor: 'pointer' }} onClick={() => handleAddFriend(friend.user[0]._id)}>סרב</span>
                                </div>
                            </div>
                        )
                        ...
                        return (
                            <div className="friend-request" key={user._id}>
                                ...
                                <div>
                                    ...
                                    {e[i] ? <span style={{ cursor: 'pointer' }}>בקשת חברות נשלחה</span> : <span onClick={() => handleAddFriend(user._id)} style={{ cursor: 'pointer' }}>Add Friend</span>}



                                    |
                                    {eAdmin[i] ? <span style={{ cursor: 'pointer' }}>אדמין</span> : <span onClick={() => handleAddAdmins(user._id)} style={{ cursor: 'pointer' }}>+ Add as admin</span>}
